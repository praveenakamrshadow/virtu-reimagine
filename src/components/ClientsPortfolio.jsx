...
const ClientsPortfolio = () => {
    return (
        <div className="dark:bg-[#F1F0E8]">
            <h1 className="uppercase text-3xl dark:mt-0 dark:pt-10 mt-10 mb-10 dark:text-black text-white text-center lexend-bold">
                Clients Portfolio
            </h1>
            ...
            <div className="mb-8 dark:pb-10 dark:mb-0 flex items-center justify-center lexend-normal">
                <Link to="/references">
