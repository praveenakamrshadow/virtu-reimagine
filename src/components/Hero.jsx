...
const Hero = () => {
    ...
    const slides = [
        {
            id: 'sap',
            heading: 'Unlock The Power Of SAP',
            subheading: 'With Expertise',
        },
        {
            id: 'ai',
            heading: 'Revolutionize Your Business With AI/ML',
            subheading: 'With Cutting Edge Technologies',
        },
        {
            id: 'digital',
                ...
                <div className="p-16 h-screen w-screen flex flex-col items-center justify-center">
                    <div ref={heroRef} className="w-full">
                        <AnimatePresence initial={false}>
                            <motion.h1
                                ...
                                className="text-[2rem] lexend-bold text-start top-10 left-[0.8rem]"
                                initial="hidden"
                                animate="visible"
                                exit="hidden"
                    ...
                    <AnimatePresence>
                        <p
                            ...
                            className="text-gray-400 inter-normal mt-16 p-3"
                        >
                            Virtu Tech Solutions is a global leader in IT,
                            business services, and software solutions. We
                            specialize in consulting, industry solutions, IT
                            modernization, and managed services. With a presence
                            in over 60 countries, we empower clients for success
                            in the digital era.
                        </p>
                    </AnimatePresence>
                    <AnimatePresence>
                        <div
                            ...
                            className="flex w-full p-4 mt-10 gap-10"
                        >
