...
const Featured = () => {
    return (
        <>
            <div
                id="featured"
                className="flex flex-col items-center h-[123vh] w-screen bg-[#151515]"
            >
                <h1 className="mt-20  lexend-normal text-xl text-center text-white">
                ...
                <p className="inter-normal mt-5 text-center w-[60%] text-gray-400">
                    ...
                    committed to our client’s long-term success and combine
                    global reach with local client attention to serve them. We
                    service our clients in more than 60 countries through
