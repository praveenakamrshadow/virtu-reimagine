const Collaboration = () => {
    return (
        <div className="flex text-white dark:text-black dark:bg-[#FEFAF6] items-center justify-center flex-col lg:flex-row lg:items-center lg:justify-center md:flex-col md:items-center md:justify-center sm:flex-col sm:items-center sm:justify-center p-8 lg:gap-x-8 md:gap-4 sm:gap-4">
